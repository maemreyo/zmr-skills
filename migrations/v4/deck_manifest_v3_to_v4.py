...
SOURCE_SCHEMA = "deck-manifest.v3"
TARGET_SCHEMA = "deck-manifest.v4"
def migrate(payload: dict[str, object], context: MigrationContext) -> MigrationOutcome:
    return classify_and_migrate(payload, context, source_schema=SOURCE_SCHEMA, target_schema=TARGET_SCHEMA, preserved={"slides", "theme", "speaker_notes"}, review_required={"empty_note_mapping"}, rejected=set(), transformed={})
